...
export default function NowPlaying() {
  ...
  return (
    <div className="flex items-center gap-2 rounded-full border border-[var(--chip-line)] bg-[var(--chip-bg)] px-3 py-1.5 text-sm text-[var(--sea-ink-soft)]">
      ...
      {data.isPlaying ? (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="max-w-[200px] truncate no-underline hover:text-[var(--sea-ink)]"
